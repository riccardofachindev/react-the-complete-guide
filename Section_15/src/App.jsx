...
function App() {
  ...
  const handleRemovePlace = useCallback(async function handleRemovePlace() {
    ...
    try {
      await updateUserPlaces(userPlaces.filter(userPlace => userPlace.id !== selectedPlace.current.id))
    } catch (error) {
      setUserPlaces(userPlaces);
  ...
  return (
    <>
      <Modal open={errorUpdatingPlaces} onClose={handleError}>
        {errorUpdatingPlaces && <ErrorMessage title="An error occurred" message={errorUpdatingPlaces.message} onConfirm={handleError}></ErrorMessage>}
      </Modal>
